...
var chart__Group3 = svg.append("g")
...
d3.csv("../db/models.csv", function(error, sales__Data) {
  ...
  // Create axes labels
  chart__Group3.append("text")
    .attr("transform", "rotate(-90)")
    .attr("y", 0 - chart_Margin.left +30)
    .attr("x", 0 - (chart_Height / 2))
    .attr("dy", "1em")
    .attr("class", "axisText")
    .text("Significance Score");
  ...
  chart__Group3.on("mouseover", function(d) {
