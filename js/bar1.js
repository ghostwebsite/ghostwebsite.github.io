...
d3.csv("../db/video_game_sales_2016.csv", function(error, sales_Data) {
  ...
  var yLinear_Scale = d3.scaleLinear()
    .domain([0, d3.max(sales_Data, d => d.NA_Sales)])
  ...
  chart_Group.selectAll(".bar")
    ...
    .attr("y", d => yLinear_Scale(d.NA_Sales))
    .attr("width", xBand_Scale.bandwidth())
    .attr("height", d => chart_Height - yLinear_Scale(d.NA_Sales));
